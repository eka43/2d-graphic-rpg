...
public class Armor extends Item {
    ...
    public Armor(String imgFilename, int price, String description) {
        init(imgFilename, 0.0, 0.0, Ragnarok.DIR_NONE, 0.0, 0.0, price, description);
    }

    public Armor(String imageFilename, double xOnMap, double yOnMap, int dir, double speedX, double speedY, int atk, int price, String description) {
